        ...
        self.laws = [
            ...
            },
            {
                ...
                "condition": lambda ctx: (
                    ctx.get("contains_minor") and ctx.get("action") == "publish"
                ),
                "operator": DeonticOperator.FORBIDDEN,
            ...
            },
            {
                "id": "LAW-04",
                "condition": lambda ctx: (
                    ctx.get("owner") == ctx.get("user") and ctx.get("action") == "watermark"
                ),
            ...
            },
            {
                "id": "LAW-05",
                "condition": lambda ctx: (
                    ctx.get("owner") != ctx.get("user") and ctx.get("action") == "remove_watermark"
                ),
                "operator": DeonticOperator.FORBIDDEN,
            ...
            {
                "id": "LAW-06",
                "condition": lambda ctx: ctx.get("coercion"),
                "operator": DeonticOperator.FORBIDDEN,
