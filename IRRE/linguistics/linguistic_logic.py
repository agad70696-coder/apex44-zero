...
class LinguisticLogic:
    ...
    def translate_preserving_intent(self, text: str) -> str:
        m = {"ابنى": "Build it now - full layer immediately (Egyptian urgent trust)", "فين 3": "Where is file 3? Built 2, missing third", "القاهرة مش كلمة": "Cairo is not a word, it's entity inside Egypt", "مشروعي 6.0 ثوري": "My project 6.0 revolutionary (status claim without evidence)"}
