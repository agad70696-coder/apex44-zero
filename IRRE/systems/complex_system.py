...
class ComplexSystem:
    ...
    def _build_apex_system(self):
        self.add_component("Evidence_Layer", "Evidence", 1.0, properties={"law": "No Evidence = No Claim"})
        ...
        self.add_component("Knowledge_Layer", "Knowledge", 1.0, properties={"understands": "Cairo=Entity"})
        self.add_component("Gate_Layer", "Agent", 1.0, properties={"qac": "44/44"})
        self.add_interaction("Evidence_Layer", "Behavioral_Layer", "feeds", 0.9, "الدليل يغذي النفسي")
    ...
    def add_component(self, cid, ctype, health=1.0, dependencies=None, properties=None):
        self.components[cid] = SystemComponent(cid, ctype, health, dependencies or [], properties or {})

    def add_interaction(self, src, tgt, itype, strength=1.0, desc=""):
